# Ingestion report — La vida de Lazarillo de Tormes

<!-- GENERATED FILE — do not edit by hand. Regenerate with: npm run ingest -- --slug lazarillo-de-tormes --dry-run -->

- **Slug**: `lazarillo-de-tormes`
- **Source**: https://www.gutenberg.org/cache/epub/320/pg320.txt
- **Cover**: jpeg 500x751, 110 KB
- **Cover licence**: Public domain (the Wikimedia Commons file page states: Public domain)
- **Cover source**: https://commons.wikimedia.org/wiki/File:Lazarillo2.jpg
