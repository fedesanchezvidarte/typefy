# Ingestion report — A Christmas Carol

<!-- GENERATED FILE — do not edit by hand. Regenerate with: npm run ingest -- --slug a-christmas-carol --dry-run -->

- **Slug**: `a-christmas-carol`
- **Source**: https://www.gutenberg.org/cache/epub/46/pg46.txt
- **Cover**: jpeg 960x1465, 498 KB
- **Cover licence**: Public domain (the Wikimedia Commons file page states: Public domain)
- **Cover source**: https://commons.wikimedia.org/wiki/File:Charles_Dickens-A_Christmas_Carol-Cloth-First_Edition_1843.jpg
