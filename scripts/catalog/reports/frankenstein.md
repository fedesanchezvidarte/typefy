# Ingestion report — Frankenstein; or, The Modern Prometheus

<!-- GENERATED FILE — do not edit by hand. Regenerate with: npm run ingest -- --slug frankenstein --dry-run -->

- **Slug**: `frankenstein`
- **Source**: https://www.gutenberg.org/cache/epub/84/pg84.txt
- **Cover**: jpeg 960x1406, 188 KB
- **Cover licence**: Public domain (the Wikimedia Commons file page states: Public domain)
- **Cover source**: https://commons.wikimedia.org/wiki/File:Christie%27s_auction_scan_of_Frankenstein_1818.jpg
