# Ingestion report — Romeo and Juliet

<!-- GENERATED FILE — do not edit by hand. Regenerate with: npm run ingest -- --slug romeo-and-juliet --dry-run -->
...
```
Romeo and Juliet is a tragedy written by William Shakespeare early in his career about two young Italian star-crossed lovers whose deaths ultimately reconcile their feuding families. It was among Shak…
```
