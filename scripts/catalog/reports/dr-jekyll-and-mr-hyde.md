# Ingestion report — The Strange Case of Dr. Jekyll and Mr. Hyde

<!-- GENERATED FILE — do not edit by hand. Regenerate with: npm run ingest -- --slug dr-jekyll-and-mr-hyde --dry-run -->

- **Slug**: `dr-jekyll-and-mr-hyde`
- **Source**: https://www.gutenberg.org/cache/epub/43/pg43.txt
- **Cover**: jpeg 636x972, 185 KB
- **Cover licence**: Public domain (the Wikimedia Commons file page states: Public domain)
- **Cover source**: https://commons.wikimedia.org/wiki/File:Jekyll_and_Hyde_Title.jpg
