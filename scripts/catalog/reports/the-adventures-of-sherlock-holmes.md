# Ingestion report — The Adventures of Sherlock Holmes

<!-- GENERATED FILE — do not edit by hand. Regenerate with: npm run ingest -- --slug the-adventures-of-sherlock-holmes --dry-run -->
...
```
The Adventures of Sherlock Holmes is a collection of twelve short stories by Arthur Conan Doyle, first published on 14 October 1892. It contains the earliest short stories featuring the consulting det…
```
